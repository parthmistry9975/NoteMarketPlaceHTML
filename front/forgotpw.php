...
<?php 
    if(isset($_POST['submit'])){
        ...
        if($emailcount){
            ...
            $query = "UPDATE users SET Password = '".$pass."',ModifiedDate = DEFAULT WHERE EmailID = '".$Email_ID."'";
        ...
        <div class="forgot-password-form">
            ...
            <div class="forgot-form">
                ...
                <form action="forgotpw.php" method="post">
                    ...
                    <input type="email" name="email_id" class="form-control form-control-sm" id="email_id" aria-describedby="emailHelp" placeholder="Enter email">
                    </div>
