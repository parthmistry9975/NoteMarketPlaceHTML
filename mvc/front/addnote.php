                ...
                <form class="profile-form col-md-12" action="addnote.php" method="post" enctype="multipart/form-data">
                    ...
                    <div class="form-row">
                        <div class="form-group col-md-6">
                            ...
                            <input type="text" name="notetitle" class="form-control" id="title" placeholder="Enter your notes title" required <?php if(isset($_POST['save'])){ echo "value="."'".$_SESSION['title']."'" ; }?>>
                        </div>
                        <div class="form-group col-md-6">
                    ...
                    <div class="form-row">
                        ...
                        <div class="form-group col-md-6">
                            ...
                            <input type="text" name="numberofpages" class="form-control" id="pages" placeholder="Enter number of note pages" required <?php if(isset($_POST['save'])){ echo "value="."'".$_SESSION['pages']."'" ; }?>>
                        </div>
                    </div>
                    <div class="form-row">
                        <div class="form-group col-md-12">
                            <label for="description">Description &#42;</label>
                            <textarea name="description" class="form-control hw" id="description" cols="50" rows="5" placeholder="Enter your description" required><?php if(isset($_POST['save'])){  echo $_SESSION['description']; }?></textarea>
                        </div>
                    </div>
                    ...
                    <div class="form-row">
                        ...
                        <div class="form-group col-md-6">
                            ...
                            <input type="text" name="institutename" class="form-control" id="institute" placeholder="Enter your institution name" required <?php if(isset($_POST['save'])){ echo "value="."'".$_SESSION['institution']."'" ; }?>>
                        </div>
                    </div>
                    ...
                    <div class="form-row">
                        <div class="form-group col-md-6">
                            ...
                            <input type="text" name="coursename" class="form-control" id="coursename" placeholder="Enter your course name" required <?php if(isset($_POST['save'])){ echo "value="."'".$_SESSION['course']."'" ; }?>>
                        </div>
                        <div class="form-group col-md-6">
                            <label for="coursecode">Course Code</label>
                            <input type="text" name="coursecode" class="form-control" id="coursecode" placeholder="Enter your course code" required <?php if(isset($_POST['save'])){ echo "value="."'".$_SESSION['coursecode']."'" ; }?>>
                        </div>
                    </div>
                    <div class="form-row">
                        <div class="form-group col-md-6">
                            <label for="professor">Professor / Lecturer</label>
                            <input type="text" name="author" class="form-control" id="professor" placeholder="Enter your professor name" required <?php if(isset($_POST['save'])){ echo "value="."'".$_SESSION['professor']."'" ; }?>>
                        </div>
                        <div class="form-group col-md-6">
                        ...
                        <div class="form-group col-md-6">
                            <div class="form-row">
                                ...
                                <div class="form-group col-md-12 margin-layout">
                                    ...
                                    <input type="text" name="sellprice" class="form-control" id="sellprice" placeholder="Enter your price" required <?php if(isset($_POST['save'])){ echo "value="."'".$_SESSION['price']."'" ; }?>>
                                </div>
                            </div>
                        </div>
                        <div class="form-group col-md-6">
