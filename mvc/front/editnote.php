...
<body>
    ...
    <?php 
        ...
        if(isset($_GET['id_note'])){
            ...
            $fetch_for_edit_array = mysqli_fetch_assoc($fetch_data);
            ...
            $edit_ispaid = $fetch_for_edit_array['IsPaiid'];
                ...
                <form class="profile-form col-md-12" action="addnote.php" method="post" enctype="multipart/form-data">
                    ...
                    <div class="form-row">
                        <div class="form-group col-md-6">
                            ...
                            <input type="text" name="notetitle" class="form-control" id="title" placeholder="Enter your notes title" required <?php if(isset($_POST['save'])){ echo "value="."'".$_SESSION['title']."'" ; } if(isset($_GET['id_note'])){ echo "value="."'".$edit_title."'"; }?>>
                        </div>
                        <div class="form-group col-md-6">
                            ...
                            <select id="category" name="notecategory" class="form-control" required>
                                ...
                                <?php
                                    ...
                                    for($i=1;$i<=$cqueryrows;$i++){
                                        ...
                                        ?>
                                        <option value="<?php echo $categoryrow['ID'];?>" <?php if(isset($_POST['save'])){if($categoryrow['ID']==$_SESSION['category']){echo "selected";}}if(isset($_GET['id_note'])){if($categoryrow['ID']==$edit_category){echo "selected";}}?>><?php echo $categoryrow['Name'] ?></option>
                                <?php
                            }
                            ?>
                    ...
                    <div class="form-row">
                        <div class="form-group col-md-6">
                            ...
                            <select id="notetype" name="notetype" class="form-control" required>
                                ...
                                ?>
                                    <option value="<?php echo $typerow['ID'] ?>" <?php if(isset($_POST['save'])){if($typerow['ID']==$_SESSION['type']){echo "selected";}}if(isset($_GET['id_note'])){if($typerow['ID']==$edit_category){echo "selected";}}?>><?php echo $typerow['Name'] ?></option>
                                <?php
                            }
                            ?>
                            </select>
                        ...
                        <div class="form-group col-md-6">
                            ...
                            <input type="text" name="numberofpages" class="form-control" id="pages" placeholder="Enter number of note pages" required <?php if(isset($_POST['save'])){ echo "value="."'".$_SESSION['pages']."'" ; } if(isset($_GET['id_note'])){ echo "value="."'".$edit_pages."'"; }?>>
                        </div>
                    </div>
                    <div class="form-row">
                        <div class="form-group col-md-12">
                            <label for="description">Description &#42;</label>
                            <textarea name="description" class="form-control hw" id="description" cols="50" rows="5" placeholder="Enter your description" required><?php if(isset($_POST['save'])){ echo "value="."'".$_SESSION['description']."'" ; } if(isset($_GET['id_note'])){ echo "value="."'".$edit_description."'"; }?></textarea>
                        </div>
                    </div>
                    ...
                    <div class="form-row">
                        <div class="form-group col-md-6">
                            ...
                            <select id="country" name="country" class="form-control" required>
                                ...
                                ?>
                                    <option value="<?php echo $countryrow['ID'] ?>" <?php if(isset($_POST['save'])){if($countryrow['ID']==$_SESSION['country']){echo "selected";}}if(isset($_GET['id_note'])){if($countryrow['ID']==$edit_country){echo "selected";}}?>><?php echo $countryrow['Name'] ?></option>
                                <?php
                                }
                                ?>
                            </select>
                        ...
                        <div class="form-group col-md-6">
                            ...
                            <input type="text" name="institutename" class="form-control" id="institute" placeholder="Enter your institution name" required <?php if(isset($_POST['save'])){ echo "value="."'".$_SESSION['institution']."'" ; } if(isset($_GET['id_note'])){ echo "value="."'".$edit_university."'"; }?>>
                        </div>
                    </div>
                    ...
                    <div class="form-row">
                        <div class="form-group col-md-6">
                            ...
                            <input type="text" name="coursename" class="form-control" id="coursename" placeholder="Enter your course name" required <?php if(isset($_POST['save'])){ echo "value="."'".$_SESSION['course']."'" ; } if(isset($_GET['id_note'])){ echo "value="."'".$edit_course."'"; }?>>
                        </div>
                        <div class="form-group col-md-6">
                            <label for="coursecode">Course Code</label>
                            <input type="text" name="coursecode" class="form-control" id="coursecode" placeholder="Enter your course code" required <?php if(isset($_POST['save'])){ echo "value="."'".$_SESSION['coursecode']."'" ; } if(isset($_GET['id_note'])){ echo "value="."'".$edit_coursecode."'"; }?>>
                        </div>
                    </div>
                    <div class="form-row">
                        <div class="form-group col-md-6">
                            <label for="professor">Professor / Lecturer</label>
                            <input type="text" name="author" class="form-control" id="professor" placeholder="Enter your professor name" required <?php if(isset($_POST['save'])){ echo "value="."'".$_SESSION['professor']."'" ; } if(isset($_GET['id_note'])){ echo "value="."'".$edit_professor."'"; }?>>
                        </div>
                        <div class="form-group col-md-6">
                            ...
                            <div class="form-row">
                                <div class="form-group col-md-12">
                                    ...
                                    <label class="radio-inline radio-layout">
                                        <input type="radio" class="radio-size" name="sellfor" value="0" required 
                                        <?php if(isset($_POST['save'])){if($_SESSION['sellfor']==0){echo "checked"; }}?>
                                        <?php if(isset($_GET['id_note'])){if($edit_ispaid == 0){echo "checked";}}?>>
                                        <label class="radio-label" for="free">&nbsp;&nbsp;&nbsp;Free</label>
                                    </label>
                                    <label class="radio-inline">
                                        <input type="radio" class="radio-size" name="sellfor" value="1" <?php if(isset($_POST['save'])){if($_SESSION['sellfor']==1){echo "checked"; } }if(isset($_GET['id_note']{if($edit_ispaid == 1){echo "checked";}}))?>><label class="radio-label" for="free">&nbsp;&nbsp;&nbsp;Paid</label>
                                    </label>
                                </div>
                                <div class="form-group col-md-12 margin-layout">
                                    <label for="sellprice">Sell Price &#42;</label>
                                    <input type="text" name="sellprice" class="form-control" id="sellprice" placeholder="Enter your price" required <?php if(isset($_POST['save'])){ echo "value="."'".$_SESSION['price']."'" ; } if(isset($_GET['id_note'])){ echo "value="."'".$edit_price."'"; }?>>
                                </div>
                            </div>
                        </div>
                        <div class="form-group col-md-6">
