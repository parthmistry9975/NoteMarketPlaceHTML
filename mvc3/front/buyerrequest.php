        ...
        <div class="container table1">
            ...
            <div class="row table-responsive table-data">
                <table class="table table-responsive">
                    ...
                    $loginid = $_SESSION['ID'];
                    $fetch_progress_query = "SELECT downloads.ID,downloads.NoteID,downloads.NoteTitle AS note_title, downloads.NoteCategory AS note_category, users.EmailID AS buyer_id , downloads.IsPaid AS sell_type, downloads.PurchasedPrice AS price, downloads.AttachmentDownloadedDate AS download_date FROM downloads INNER JOIN users ON downloads.Downloader = users.ID WHERE IsSellerHasAllowedDownload = 0 AND downloads.Seller = $loginid GROUP BY downloads.NoteID,downloads.Downloader";
                    ...
                    ?>
                        <tr>
                            ...
                            <td><?php echo '<a href="notedetails.php?noteid="'.$progress_row["NoteID"].'><img src="images/dashboard/eye.png" alt="view"></a>'; ?></td>
                            ...
                            <div class="dropdown-menu" aria-labelledby="dLabel">
                                <a class="dropdown-item" href="allowdownload.php?allow='.$progress_row["ID"].'&noteid='.$progress_row["NoteID"].'">Allow Download</a>
                            </div>' ?></td>
                        </tr>
                    <?php  
                        $i++;
