        ...
        <div class="container table1">
            ...
            <div class="row table-data">
                <table class="table table-responsive">
                    ...
                    $loginid = $_SESSION['ID'];
                    $fetch_progress_query = "SELECT downloads.ID,downloads.NoteTitle AS note_title, downloads.NoteCategory AS note_category, users.EmailID AS buyer_id , downloads.IsPaid AS sell_type, downloads.PurchasedPrice AS price, downloads.AttachmentDownloadedDate AS download_date FROM downloads , users WHERE  downloads.Downloader = users.ID AND `IsSellerHasAllowedDownload` = 0 AND IsEmailVerified = 1 AND Seller = $loginid ";
