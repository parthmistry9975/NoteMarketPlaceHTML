                        ...
                        <div class="form-group col-md-6">
                            <div class="form-row c-row">
                                <div class="form-group col-md-12">
                                    ...
                                    <input type="text" name="sender_name" class="form-control" id="fullname" placeholder="Enter your full name" value="<?php if(isset($_SESSION['ID'])){ echo $fullname; } ?>" <?php if(isset($_SESSION['ID'])){ echo "readonly"; } ?> required>
                                </div>
                            </div>
                            <div class="form-row c-row">
                                <div class="form-group col-md-12">
                                    <label for="email">Email Address &#42;</label>
                                    <input type="email" name="sender_id" class="form-control" id="email" placeholder="Enter your email address" value="<?php if(isset($_SESSION['ID'])){ echo $emailid; } ?>" <?php if(isset($_SESSION['ID'])){ echo "readonly"; } ?> required>
                                </div>
                            </div>
                            <div class="form-row c-row">
                                <div class="form-group col-md-12">
